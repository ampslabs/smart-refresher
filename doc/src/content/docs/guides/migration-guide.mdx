...
- **Flutter 3.x Compatibility**: Built for the latest Flutter 3.47+ and Dart 3.12+ (requires the decoupled `material_ui` / `cupertino_ui` packages; use `smart_refresher ^1.0.x` on older Flutter).
